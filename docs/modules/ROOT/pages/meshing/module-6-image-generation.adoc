...
This module generates a 3D isotropic image using the center lines file, which is
 both cleaner and smoother than the original MRI.
...
- `--radius-array-name=MaximumInscribedSphereRadius`: (string) Inscribed sphere
radius array name
