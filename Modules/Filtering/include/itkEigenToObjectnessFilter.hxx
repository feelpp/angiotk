...
=========================================================================*/
#ifndef __itkEigenToObjectnessFilter_txx
#define __itkEigenToObjectnessFilter_txx
...
namespace itk
{
	...
	*/
	...
	{
		return dynamic_cast<ArrayOutputImageType *>(
	...
	typename EigenToObjectnessFilter<TInputPixel,TOutputPixel,VDimension>::ROutputImageType *
		...
		::GetROutput( void )
	{
		return dynamic_cast<ROutputImageType *>(
		...
		::GenerateData()
	{
		...
		//ImageRegionIterator<ArrayOutputImageType> valit;
		//valit = ImageRegionIterator<ArrayOutputImageType>(eigenValuesOutput, //eigenValuesOutput->GetRequestedRegion());
