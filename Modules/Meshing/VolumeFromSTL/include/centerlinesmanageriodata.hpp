...
std::vector< std::tuple< std::vector<double>,double,int > >
...
std::vector< std::pair< std::tuple< std::vector<double>, double >, std::tuple< std::vector<double>, double >  > >
loadFromPointPairFile( std::string const& pathFile )
{
  namespace fs = boost::filesystem;

  std::vector< std::pair< std::tuple< std::vector<double>, double >, std::tuple< std::vector<double>, double >  > > res;
  if ( !fs::exists( pathFile ) )
    return res;
