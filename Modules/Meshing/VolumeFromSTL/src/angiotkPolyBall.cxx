...
=========================================================================*/
#include <angiotkPolyBall.h>
#include <vtkvmtkConstants.h>
#include <vtkPointData.h>
#include <vtkObjectFactory.h>


vtkStandardNewMacro(angiotkPolyBall);

angiotkPolyBall::angiotkPolyBall()
{
  this->Input = NULL;
...
double angiotkPolyBall::EvaluateFunction(double x[3])
{
  double px[3], pr;
  int i;
...
void angiotkPolyBall::EvaluateGradient(double x[3], double n[3])
{
...
void angiotkPolyBall::PrintSelf(ostream& os, vtkIndent indent)
{
